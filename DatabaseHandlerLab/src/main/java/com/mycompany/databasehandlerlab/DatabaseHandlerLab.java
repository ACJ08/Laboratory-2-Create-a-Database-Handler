...
public class DatabaseHandlerLab {
    public static void main(String[] args) {
       ...
       // Call  method 
        ...
        Student newInsertStudent = new Student("12340102023", "Anne", "G.", "Jonson", "F", "2004-11-08", 2023, "CICS", 15, "Manila City");
        
        Student newInsertStudent2 = new Student("44440102024", "Juana", "G.", "Reyes", "F", "2004-11-08", 2024, "CICS", 15, "Manila City");
        ...
        Student retrievedStudent = dbHandler.getStudent("12340102023");
        ...
        Student updatedStudent = new Student("12340102023", "Anne Carol", "G.", "Jonson", "F", "2000-01-01", 2023, "CICS", 15, "456 Main St.");
        boolean updateSuccess = dbHandler.updateStudentInfo("12340102023", updatedStudent);
        System.out.println("Update success: " + updateSuccess);
        
        //  Update student units (subtract 3 units)
        boolean updateUnitsSuccess = dbHandler.updateStudentUnits("12340102023", 3);
        System.out.println("Update units success: " + updateUnitsSuccess);
    
     //  Remove a student
        boolean removeSuccess = dbHandler.removeStudent("12340102023");
